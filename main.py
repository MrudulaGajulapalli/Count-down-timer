...
class CountDown:
    def __init__(self, root):
        ...
        self.time_frame = Frame(self.window, bg="gray35", width=480, height=120)
        self.time_frame.place(x=0, y=210)
    ...
    def Get_Time(self):
        ...
        try:
            ...
            if s == 0 and m == 0 and h == 0:
                ...
                pause_button = Button(self.button_frame, text='Pause', font=('Helvetica', 12), bg="red", fg="white",
    ...
    def start_time(self):
        ...
        while self.time_left > 0:
            ...
            if self.time_left <= 0:
                messagebox.showinfo('Time Over', 'Countdown timer reached zero.')
                self.Clear_Screen()
                if self.pause == True:
                    break
